...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_load_show_file = QPushButton(self.groupBox_load)
        self.pushButton_load_show_file.setObjectName(u"pushButton_load_show_file")
        self.pushButton_load_show_file.setMinimumSize(QSize(75, 25))
        self.pushButton_load_show_file.setMaximumSize(QSize(75, 25))

        self.horizontalLayout_3.addWidget(self.pushButton_load_show_file)
